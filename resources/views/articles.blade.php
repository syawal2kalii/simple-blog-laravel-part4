                        ...
                        <div class="col-sm-12 col-md-4">
                            <div class="single-blog">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <a href="#"><p class="blog-date">Dec 17 2019 <br> Posted by {name} </p> </a>
                                        {{--                                    <p>Posted By</p>--}}
                                        ...
                                        <a href="{{route("article.detail",$data)}}" class="btn btn-outline-primary style-3 text-dark">Read More</a>
                                    </div>
                                </div>
                            </div>
                        </div>
